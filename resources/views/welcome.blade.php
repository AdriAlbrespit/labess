...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">           <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
          <a href="#"><img class="img-fluid" src="img/LABESSLOGO.png" alt=""></a>
          </a></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#evenements">Évènements</a>
          </li>
          <li class="nav-item">
  ...
  <!-- Nos missions -->
  <section class="bg-light" id="nosmissions">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
  ...
  <section class="bg-light" id="agir">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Soutenez Labess !</h2>
          <h3 class="section-subheading text-muted">Nous vous proposons différents types de dons : </h3>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-4">
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          <span class="copyright">Copyright &copy; LABESS 2019</span>
        </div>
        <div class="col-md-4">
